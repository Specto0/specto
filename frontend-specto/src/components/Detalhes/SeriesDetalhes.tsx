          ...
          <div className="detalhes-texto">
            ...
            <div className="detalhes-info">
              {serie.data_lancamento && (
                <p><strong>Estreia:</strong> {serie.data_lancamento}</p>
              )}
              {serie.nota && (
                <p><strong>Nota:</strong> {serie.nota} ⭐</p>
              )}
              {serie.adult !== undefined && (
                <p><strong>Classificação:</strong> {serie.adult ? "Adulto" : "Livre"}</p>
              )}
              {serie.generos && (
              ...
              {serie.orcamento && (
                <p><strong>Orçamento:</strong> ${serie.orcamento.toLocaleString()}</p>
              )}
              {serie.receita && (
                <p><strong>Receita:</strong> ${serie.receita.toLocaleString()}</p>
              )}
            </div>
          </div>
        </div>
